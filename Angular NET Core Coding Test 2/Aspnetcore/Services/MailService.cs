...
namespace WebApi.Services
{
    ...
    public interface IMailService
    {
        ...
        IEnumerable<MailModel> GetSentMailsByFolder(int paramFolderId, int userId);
    }
    ...
    public class MailService : IMailService, IDisposable
    {
        ...
        public IEnumerable<MailModel> GetSentMailsByFolder(int paramFolderId, int userId)
        {
            _log.LogDebug("GetSentMailsByFolder(int paramFolderId, int userId)", paramFolderId, userId);

            SqlParameter userIdParam = new SqlParameter("@UserID", userId);
            SqlParameter folderIdParam = new SqlParameter("@Folder", paramFolderId);

            var mailsSentResults = _context.MailModel.FromSqlRaw(
                SqlConstants.GET_SENT_FOLDER,
                parameters: new[] { userIdParam, folderIdParam });

            return mailsSentResults;
        }
